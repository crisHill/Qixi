package zls.com.qixi.baiduvoice;
...
public class VoiceRecognizer {
     ...
     */
    public VoiceRecognizer(Context context, IRecogListener recogListener) {
     ...
     */
    public VoiceRecognizer(Context context, EventListener eventListener) {
        if (isInited) {
